          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center mb-6">
              <button
                ...
                className="group w-56 h-28 rounded-2xl bg-slate-900/60 border-2 border-cyan-500/60 backdrop-blur-sm
              ...
              >
                {isSpinning ? (
                  <div className="flex flex-col items-center font-lilita text-slate-400">
                    ...
                    <span className="text-xl tracking-wider uppercase">Spinning...</span>
                  </div>
                ) : (
                  <>
                    <span className="font-lilita text-5xl uppercase text-cyan-400 drop-shadow-[0_0_8px_rgba(100,220,255,0.7)] group-disabled:text-slate-500 group-disabled:drop-shadow-none">
                      SPIN
                    </span>
                    <div className="flex items-center mt-2 group-disabled:opacity-50">
                      {currentCoins < 100 ? (
                        <span className="font-lilita text-xl text-red-400/80 tracking-wide">Hết xu</span>
                      ) : (
                        <div className="flex items-center">
                          <span className="font-lilita text-2xl text-sky-400">100</span>
                          <CoinsIcon src="https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/dollar.png" className="w-6 h-6 ml-2 drop-shadow-md" />
                        </div>
                      )}
                    </div>
                  </>
