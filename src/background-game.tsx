...
const AuctionHouse = lazy(() => import('./home/auction/AuctionHouse.tsx')); // Mới
           ...
           <div className={`${className ?? ''} relative w-full h-full rounded-lg overflow-hidden shadow-2xl bg-transparent`} onClick={handleTap}>
            ...
            <div className="absolute left-4 bottom-32 flex flex-col space-y-4 z-30">
              {[ 
                  ...
                  { icon: <img src={uiAssets.auctionIcon} alt="Auction House Icon" className="w-full h-full object-contain" />, onClick: toggleAuctionHouse } // Mới
