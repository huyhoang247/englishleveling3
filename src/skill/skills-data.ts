// --- START OF FILE skills.data.ts (fixed) ---

import React from 'react';

// --- ICONS CHO KỸ NĂNG ---
// Các icon này được định nghĩa ở đây để đi kèm với dữ liệu kỹ năng.
export const FireballIcon = ({ className = '' }: { className?: string }) => (
...
export const IceShardIcon = ({ className = '' }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
// --- END OF FILE skills.data.ts (fixed) ---
