// --- START OF FILE data/skills.ts ---

import React from 'react';

// --- ICONS ---
// Chúng ta export các Icon để có thể sử dụng trong mảng ALL_SKILLS bên dưới
// và cũng để có thể import riêng lẻ nếu cần.
...
export const BookIcon = ({ className = '' }: { className?: string }) => ( <img src="https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/20250720_1859_Icon%20S%C3%A1ch%20C%E1%BB%95%20Anime_simple_compose_01k0kv0rg5fhzrx8frbtsgqk33.png" alt="Sách Cổ" className={className} /> );
