...
Sopranos: The highest female voices, including Coloratura, Lyric, and Dramatic Sopranos.

Mezzo-Sopranos & Altos: The middle and lower female voices, from Mezzo-Sopranos (my voice type) down to Contraltos.

Tenors: The highest male voices, including Countertenors, Light Tenors, Dramatic Tenors, and Heldentenors.

Baritones & Basses: The middle and lowest male voices.
...
Fundamentally, this begins with the breath. You must understand what it is and how to support that breath in your body—with your diaphragm, your rib cage, your back, and your lower abdomen. This support allows you to create that wonderful, hollow, resonant sound, which is then shaped by the articulators: the tongue, the teeth, and the lips.

The Balloon Analogy

Think of it this way: if you blow up a balloon and fill it with air, what happens if you don't hold on to the mouth of it? The air rushes out, and the balloon flies all over the place.

With singing, you want to hold on to the mouth of the balloon. You take in air, and you have to spend that air, but you must make sure you don't use it all up at once. Your breath support is the hand on the mouth of the balloon, allowing you to dole that air out evenly. You don't let it all go on the first phrase; you gauge the breath and spend it wisely throughout the entire musical line.

The Final, Most Important Truth

The bottom line—the bottom, bottom, bottom line—is this: if it isn't real, we know.

It has to be real. It has to be honest. That is the thing that is transformative for people when they go to the theater. They come and they're riveted because they're seeing something happen in real time that is authentic.
...
Nữ cao (Soprano): Loại giọng nữ cao nhất, bao gồm Nữ cao màu sắc (Coloratura), Nữ cao trữ tình (Lyric), và Nữ cao kịch tính (Dramatic).

Nữ trung & Nữ trầm (Mezzo-Soprano & Alto): Các loại giọng nữ trung và trầm, từ Nữ trung (Mezzo-Soprano) – là loại giọng của tôi – xuống đến Nữ trầm (Contralto).

Nam cao (Tenor): Loại giọng nam cao nhất, bao gồm Phản nam cao (Countertenor), Nam cao trữ tình (Light Tenor), Nam cao kịch tính (Dramatic), và Nam cao anh hùng (Heldentenor).

Nam trung & Nam trầm (Baritone & Bass): Các loại giọng nam trung và trầm nhất.
...
Và điều quan trọng nhất chính là kỹ thuật, kỹ thuật, kỹ thuật và kỹ thuật.

Về cơ bản, mọi thứ bắt đầu từ hơi thở. Bạn phải hiểu nó là gì và làm thế nào để nâng đỡ làn hơi đó trong cơ thể mình – bằng cơ hoành, lồng ngực, lưng và bụng dưới. Sự nâng đỡ này cho phép bạn tạo ra âm thanh rỗng, vang vọng tuyệt vời, sau đó được định hình bởi các cơ quan phát âm: lưỡi, răng và môi.

Phép ẩn dụ về Quả bóng bay

Hãy hình dung thế này: nếu bạn thổi căng một quả bóng bay và chứa đầy không khí trong đó, điều gì sẽ xảy ra nếu bạn không giữ chặt miệng của nó? Không khí sẽ phụt ra ngoài, và quả bóng sẽ bay loạn xạ khắp nơi.

Với việc ca hát, bạn muốn giữ chặt miệng của quả bóng bay. Bạn lấy không khí vào, và bạn phải sử dụng không khí đó, nhưng bạn phải chắc chắn rằng bạn không dùng hết nó ngay lập tức. Việc kiểm soát hơi thở chính là bàn tay giữ chặt miệng quả bóng, cho phép bạn phân phối không khí đó ra một cách đều đặn. Bạn không để tất cả thoát ra ở câu hát đầu tiên; bạn đo lường hơi thở và sử dụng nó một cách khôn ngoan trong suốt toàn bộ giai điệu.

Sự Thật Cuối Cùng và Quan Trọng Nhất

Điểm mấu chốt – điểm mấu chốt cuối cùng – là thế này: Nếu nó không thật, chúng tôi biết.

Nó phải thật. Nó phải chân thành. Đó chính là điều tạo nên sự biến đổi, lay động khán giả khi họ đến nhà hát. Họ đến và bị cuốn hút vì họ đang chứng kiến một điều gì đó xảy ra trong thời gian thực, một điều đích thực.
