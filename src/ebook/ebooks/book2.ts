...
Part 1: The Confessions of a College Procrastinator

So in college, I was a government major, which means I had to write a lot of papers. Now, when a normal student writes a paper, they might spread the work out a little like this. So, you know -- (Laughter) -- you get started maybe a little slowly, but you get enough done in the first week that, with some heavier days later on, everything gets done, things stay civil. (Laughter)

And I would want to do that like that. That would be the plan. I would have it all ready to go, but then, actually, the paper would come along, and then I would kind of do this. (Laughter) And that would happen every single paper.
...
Part 4: The Guardian Angel: The Panic Monster
...
Well, turns out the procrastinator has a guardian angel, someone who's always looking down on him and watching over him in his darkest moments -- someone called the Panic Monster. (Laughter)
...
So the Panic Monster starts losing his mind, and a few seconds later, the whole system's in mayhem. (Laughter) And the Monkey -- remember, he's terrified of the Panic Monster -- boom, he's up the tree! And finally, finally, the Rational Decision-Maker can take the wheel and I can start working on the talk.

Part 5: The Two Kinds of Procrastination
...
Now, I want to show you one last thing. I call this a Life Calendar. That's one box for every week of a 90-year life. That's not that many boxes, especially since we've already used a bunch of those.

So I think we need to all take a long, hard look at that calendar. We need to think about what we're really procrastinating on, because everyone is procrastinating on something in life. We need to stay aware of the Instant Gratification Monkey. That's a job for all of us. And because there's not that many boxes on there, it's a job that should probably start today.

Well, maybe not today, but... (Laughter) You know. Sometime soon.
...
Phần 1: Lời Thú Tội Của Một Kẻ Trì Hoãn Thời Đại Học

Hồi còn học đại học, tôi học chuyên ngành chính phủ, đồng nghĩa với việc tôi phải viết rất nhiều bài luận. Bây giờ, khi một sinh viên bình thường viết bài luận, họ có thể sẽ phân bổ công việc ra một chút như thế này. Thì, bạn biết đấy -- (Tiếng cười) -- bạn có thể bắt đầu hơi chậm một chút, nhưng bạn hoàn thành đủ trong tuần đầu tiên để rồi với vài ngày cật lực hơn sau đó, mọi thứ sẽ được giải quyết, mọi việc vẫn trong tầm kiểm soát. (Tiếng cười)

Và tôi cũng muốn làm theo cách đó. Đó sẽ là kế hoạch. Tôi sẽ chuẩn bị sẵn sàng mọi thứ, nhưng rồi trên thực tế, khi bài luận đến hạn, tôi lại làm theo kiểu này. (Tiếng cười) Và chuyện đó xảy ra với mọi bài luận.

Nhưng rồi đến lượt bài luận văn tốt nghiệp dài 90 trang của tôi, một bài mà bạn được cho là phải dành cả năm để thực hiện. Và tôi biết rằng với một bài luận như thế, quy trình làm việc bình thường của tôi là một lựa chọn bất khả thi. Nó là một dự án quá lớn. Vì vậy, tôi đã lên kế hoạch và quyết định rằng mình phải thực hiện theo một biểu đồ trông như thế này. Đây là cách cả năm sẽ diễn ra. Tôi sẽ bắt đầu nhẹ nhàng, tăng tốc ở những tháng giữa, và đến cuối cùng, tôi sẽ vào số cao nhất, giống như leo lên một cầu thang nhỏ vậy. Leo lên vài bậc thang thì khó đến mức nào chứ? Chuyện nhỏ, phải không?
...
Dù sao thì, hiện tại tôi là một người viết blog. Tôi viết cho blog "Wait But Why". Và vài năm trước, tôi quyết định viết về sự trì hoãn. Hành vi của tôi luôn làm những người không trì hoãn xung quanh tôi bối rối, và tôi muốn giải thích cho những người không trì hoãn trên thế giới biết điều gì đang diễn ra trong đầu những kẻ trì hoãn, và tại sao chúng tôi lại như vậy.
...
Vậy, chuyện gì đang xảy ra ở đây? Chú Khỉ Thỏa Mãn Tức Thì có vẻ không phải là gã bạn muốn ngồi sau tay lái. Nó sống hoàn toàn trong khoảnh khắc hiện tại. Nó không có ký ức về quá khứ, không có kiến thức về tương lai, và nó chỉ quan tâm đến hai điều: dễ dàng và vui vẻ.

Trong thế giới động vật, điều đó hoàn toàn ổn. Nếu bạn là một con chó và bạn dành cả đời mình không làm gì khác ngoài những việc dễ dàng và vui vẻ, bạn là một thành công lớn! (Tiếng cười) Và đối với Chú Khỉ, con người chỉ là một loài động vật khác. Bạn phải ngủ đủ giấc, ăn no và duy trì nòi giống cho thế hệ tiếp theo. Điều này có thể đã hoạt động tốt trong thời bộ lạc. Nhưng, nếu bạn chưa nhận ra, chúng ta không còn ở thời bộ lạc nữa. Chúng ta đang ở trong một nền văn minh tiên tiến, và Chú Khỉ không biết đó là gì.

Đó là lý do tại sao chúng ta có một người khác trong não, Người Ra Quyết Định Lý Trí, người cho chúng ta khả năng làm những việc mà không loài động vật nào khác có thể làm. Chúng ta có thể hình dung tương lai. Chúng ta có thể nhìn thấy bức tranh toàn cảnh. Chúng ta có thể lập kế hoạch dài hạn. Và anh ấy muốn chúng ta làm bất cứ điều gì có ý nghĩa nhất vào lúc này.

Đôi khi, làm những việc dễ dàng và vui vẻ là hợp lý, như khi bạn ăn tối, đi ngủ hoặc tận hưởng thời gian giải trí xứng đáng. Đó là lý do tại sao có một sự trùng lặp. Đôi khi họ đồng ý. Nhưng những lúc khác, việc làm những điều khó khăn và kém dễ chịu hơn lại có ý nghĩa hơn nhiều, vì lợi ích của bức tranh toàn cảnh. Và đó là lúc chúng ta có xung đột. Và đối với kẻ trì hoãn, cuộc xung đột đó có xu hướng kết thúc theo một cách nhất định mỗi lần, khiến anh ta dành rất nhiều thời gian trong vùng màu cam này, một nơi dễ dàng và vui vẻ nhưng hoàn toàn nằm ngoài Vòng Tròn "Hợp Lý". Tôi gọi nó là Sân Chơi Tăm Tối. (Tiếng cười)

Sân Chơi Tăm Tối là nơi mà tất cả những người trì hoãn các bạn đều biết rất rõ. Đó là nơi các hoạt động giải trí diễn ra vào những thời điểm mà chúng không nên diễn ra. Niềm vui bạn có trong Sân Chơi Tăm Tối không thực sự là niềm vui, vì nó hoàn toàn không xứng đáng có được, và không khí thì tràn ngập cảm giác tội lỗi, sợ hãi, lo lắng, và tự căm ghét bản thân — tất cả những cảm xúc "tốt đẹp" của kẻ trì hoãn.

Phần 4: Vị Cứu Tinh: Quái Vật Hoảng Loạn

Câu hỏi là, trong tình huống này, với Chú Khỉ ngồi sau tay lái, làm thế nào kẻ trì hoãn có thể tự đưa mình đến vùng màu xanh này, một nơi kém dễ chịu hơn, nhưng là nơi những điều thực sự quan trọng xảy ra?

Chà, hóa ra kẻ trì hoãn có một thiên thần hộ mệnh, một người luôn dõi theo và bảo vệ anh ta trong những khoảnh khắc đen tối nhất — người đó được gọi là Quái Vật Hoảng Loạn. (Tiếng cười)

Quái Vật Hoảng Loạn hầu như luôn ngủ yên, nhưng nó đột ngột thức dậy bất cứ khi nào hạn chót đến quá gần hoặc có nguy cơ bị bẽ mặt trước công chúng, một thảm họa nghề nghiệp hoặc một hậu quả đáng sợ nào đó. Và quan trọng là, nó là thứ duy nhất mà Chú Khỉ khiếp sợ.
...
Thế là Quái Vật Hoảng Loạn bắt đầu phát điên, và vài giây sau, toàn bộ hệ thống trở nên hỗn loạn. (Tiếng cười) Và Chú Khỉ – hãy nhớ, nó rất sợ Quái Vật Hoảng Loạn – bùm, nó leo tót lên cây! Và cuối cùng, cuối cùng thì, Người Ra Quyết Định Lý Trí mới có thể cầm lái và tôi có thể bắt đầu làm bài nói chuyện.

Phần 5: Hai Loại Trì Hoãn
...
Khi đọc những email đó, tôi đã có một sự giác ngộ nhỏ — rằng tôi không nghĩ người không trì hoãn tồn tại. Đúng vậy, tôi nghĩ tất cả các bạn đều là những kẻ trì hoãn. Có thể không phải tất cả các bạn đều là một mớ hỗn độn như một số người trong chúng ta, (Tiếng cười) và một số bạn có thể có một mối quan hệ lành mạnh với các hạn chót. Nhưng hãy nhớ: thủ đoạn tinh vi nhất của Chú Khỉ là khi không có hạn chót.

Tôi muốn cho bạn xem một thứ cuối cùng. Tôi gọi đây là Cuốn Lịch Cuộc Đời. Mỗi ô vuông là một tuần trong một cuộc đời 90 năm. Số ô vuông đó không nhiều đến thế đâu, đặc biệt là khi chúng ta đã sử dụng hết một mớ rồi.

Vì vậy, tôi nghĩ tất cả chúng ta cần phải nhìn thật lâu và thật kỹ vào cuốn lịch đó. Chúng ta cần suy nghĩ về những gì chúng ta đang thực sự trì hoãn, bởi vì mọi người đều đang trì hoãn một điều gì đó trong cuộc sống. Chúng ta cần phải luôn nhận thức về Chú Khỉ Thỏa Mãn Tức Thì. Đó là công việc của tất cả chúng ta. Và bởi vì không có nhiều ô vuông trên đó, đó là một công việc có lẽ nên bắt đầu ngay hôm nay.

Chà, có thể không phải hôm nay, nhưng... (Tiếng cười) bạn biết đấy. Sớm thôi.
