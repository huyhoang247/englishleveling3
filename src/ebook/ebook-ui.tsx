                ...
                <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-2">
                    {currentUser && bookVocabularyCardIds.length > 0 && (
                        <button onClick={() => setIsBatchPlaylistModalOpen(true)} className={buttonClass}>
                            <img src="https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/assets/images/save-bookmark.webp" alt="Lưu" className="h-5 w-5 mr-2" />
                            <span>Lưu</span>
                        </button>
                    )}
                    <button onClick={() => setIsStatsModalOpen(true)} className={buttonClass}>
                        <img src="https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/assets/images/statistical.webp" alt="Thống kê" className="h-5 w-5 mr-2" />
                        <span>Thống kê</span>
                    </button>
                    {currentBook && (
                        <button onClick={() => setIsClozeTestModalOpen(true)} className={buttonClass}>
                            <img src="https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/assets/images/practice.webp" alt="Luyện tập" className="h-5 w-5 mr-2" />
                            <span>Luyện tập</span>
                        </button>
                    )}
