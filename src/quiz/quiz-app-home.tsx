    ...
    const renderRewardTiers = () => {
        ...
        const generateTiersForLevel = (levelProgress, levelNumber, levelTitle, multiplier) => {
            ...
            for (let i = 1; i <= MAX_MILESTONES_TO_DISPLAY; i++) {
                ...
                levelTiers.push(
                    <div key={rewardId} className="flex items-center justify-between bg-white p-3 rounded-xl shadow-sm border border-gray-100">
                        <div>
                            <div className="inline-flex items-center bg-gray-100 text-indigo-600 font-bold text-xs px-2.5 py-1 rounded-full mb-2">
                            ...
                            <div className="flex items-center gap-3 mt-1">
                                <div className="bg-orange-100 rounded-full px-3 py-1.5 inline-flex items-center gap-1.5">
                                    <GoldCoinIcon className="w-4 h-4" />
                                    <span className="text-sm font-bold text-orange-700">{rewardAmount.toLocaleString()}</span>
                                </div>
                                <div className="bg-blue-100 rounded-full px-3 py-1.5 inline-flex items-center gap-1.5">
