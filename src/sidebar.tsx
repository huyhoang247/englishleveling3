...
const PickaxeIcon = ({ size = 24, color = 'currentColor', className = '', ...props }) => (
  <svg
    ...
    {...props}
  >
    {/* Simplified pickaxe icon path */}
    <path d="M10 22l-2-2"></path>
    <path d="M10 22V12l5-5 5 5-5 5z"></path>
    <path d="M5 17l-2-2"></path>
    <path d="M15 7l2-2"></path>
    <path d="M10 12l-5 5"></path>
    <path d="M22 12h-5"></path>
  </svg>
);

// NEW: Inline SVG for a Dice icon (for Lucky Game)
...
function SidebarLayout({
  ...
  onShowHelp,
  onShowGoldMine,
  onShowLuckyGame // NEW: Destructure onShowLuckyGame
}: SidebarLayoutProps) {
