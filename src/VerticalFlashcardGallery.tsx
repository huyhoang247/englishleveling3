...
const MenuIcon = ({ className = "h-6 w-6" }: { className?: string }) => ( <img src="https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/assets/images/menu-icon-2.webp" alt="Menu Icon" className={className} /> );
// --- END: ICONS ---
