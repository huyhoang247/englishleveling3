// ========================================================================
// FILE: VerticalFlashcardGallery.tsx (LOGIC UPDATED & SETTINGS FIXED)
// ========================================================================

import { useRef, useState, useEffect } from 'react';
import FlashcardDetailModal from './story/flashcard.tsx';
import AddToPlaylistModal from './AddToPlaylistModal.tsx'; // Import modal
...
interface Flashcard {
  ...
  isFavorite: boolean; // Sẽ được xác định bởi việc thẻ có trong playlist nào không
  vocabulary: VocabularyData;
}

// --- Dữ liệu Ảnh và Từ vựng Mẫu (Không thay đổi, giữ nguyên) ---
              ...
              <div className="flex justify-between items-center mb-4 px-4">
                ...
                <div className="flex items-center space-x-2">
                  <button onClick={() => toggleSidebar?.()} className="relative flex items-center justify-center p-2 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 transition-all duration-300 cursor-pointer hover:border-indigo-300 hover:bg-indigo-50 dark:hover:bg-indigo-900 ring-2 ring-indigo-100 dark:ring-indigo-800" aria-label="Toggle Sidebar">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 dark:text-gray-400 transition-all duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
                  </button>
