// --- START OF FILE fill-word-home.tsx (FULL & FIXED) ---
...
import ImageCarousel3D from './image-carousel-3d.tsx'; // <-- THAY ĐỔI 1: Thêm import mới
...
export default function VocabularyGame() {
  ...
  // --- THAY ĐỔI 2: Thêm hàm helper để chuẩn bị dữ liệu ảnh cho carousel ---
          ...
          <>
            ...
            {currentWord && (
              <div className="w-full space-y-6">
                ...
                {/* --- THAY ĐỔI 3: Thay thế khối ảnh tĩnh bằng component Carousel 3D --- */}
                <ImageCarousel3D
...
// --- END OF FILE fill-word-home.tsx (FULL & FIXED) ---
