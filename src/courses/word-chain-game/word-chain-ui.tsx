// --- START OF FILE: src/word-chain.tsx ---
...
const WordChainGameView = ({ onGoBack }: { onGoBack: () => void }) => {
    ...
    // Render function for the chat chain
    const renderChain = () => {
                        ...
                        <Fragment>
                            <form onSubmit={handlePlayerSubmit} className="flex items-center gap-3">
                                ...
                                <input
                                    ...
                                    className="w-full text-lg p-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 transition cursor-default placeholder:text-gray-500 text-gray-800"
                                    autoComplete="off"
                                    autoCapitalize="none"
                                />
