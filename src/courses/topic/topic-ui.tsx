...
// - Adjusted translation to -translate-y-4 (was -translate-y-8)
const FlashcardSkeleton = ({ onClose }: { onClose: () => void }) => (
    <div className="fixed inset-0 z-[200] bg-slate-900/95 backdrop-blur-md flex flex-col h-full animate-popup-zoom touch-none select-none">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 relative overflow-hidden">
            {/* Modified: -translate-y-4 to lower it a bit compared to -translate-y-8 */}
            <div className="relative w-[90%] max-w-md h-[70vh] -translate-y-4 bg-slate-800 rounded-3xl overflow-hidden shadow-2xl border border-slate-700/50">
                {/* Shimmer Effect */}
