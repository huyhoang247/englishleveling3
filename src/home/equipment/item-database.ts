...
export const itemBlueprints: ItemBlueprint[] = [
    ...
    { 
        ...
        name: 'Glaive', 
        type: 'weapon', 
        baseDescription: 'Loại vũ khí cán dài với lưỡi kiếm lớn ở đầu, mang lại sự kết hợp hoàn hảo giữa tầm đánh của giáo và sức chém của kiếm.', 
        icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/assets/equipment/glaive.webp', 
