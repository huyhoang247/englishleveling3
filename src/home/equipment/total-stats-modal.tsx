...
const TotalStatsModal = memo(({ isOpen, onClose, equipmentStats, upgradeStats }: {
    ...
    return (
        <div 
            ...
            onClick={onClose}
        >
            {/* Backdrop overlay đã được loại bỏ tại đây */}
            
            <div 
                className="relative bg-black/85 p-5 rounded-xl border-2 border-slate-700 shadow-2xl w-full max-w-sm z-50 flex flex-col font-lilita"
                onClick={(e) => e.stopPropagation()} // Ngăn chặn đóng modal khi nhấn vào bên trong content
            >
