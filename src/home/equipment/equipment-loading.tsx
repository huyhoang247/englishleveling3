// --- START OF FILE equipment-loading.tsx ---

import React from 'react';

const EquipmentScreenSkeleton = () => {
    return (
...
export default EquipmentScreenSkeleton;

// --- END OF FILE equipment-loading.tsx ---
