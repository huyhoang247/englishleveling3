            ...
            >
                ...
                */}
                <div className={animClass}>
                    ...
                    {/* HP Bar - Đã nhích lên thêm 1 xíu nữa (giảm translate-y) */}
                    <div className="w-32 md:w-48 z-20 translate-y-2 md:translate-y-10 translate-x-2 transition-transform duration-200 group-hover:scale-105">
                         <HealthBar 
                            current={stats.hp} 
                            max={stats.maxHp} 
