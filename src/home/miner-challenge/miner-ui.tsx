    ...
    <main className="relative text-white min-h-screen flex flex-col items-center p-4 font-poppins">
      ...
      <div className="relative z-10 w-full max-w-xs sm:max-w-sm mx-auto pt-24">
        <div className="bg-slate-800/50 p-3 rounded-xl mb-6 shadow-lg border border-slate-700 grid grid-cols-2 gap-3">
            ...
            <div className="bg-black/70 rounded-lg px-3 py-2 flex items-center justify-start gap-3" title={`Current Floor: ${currentFloor}`}>
            ...
            <div className="bg-black/70 rounded-lg px-3 py-2 flex items-center justify-start gap-3" title={`Pickaxes Remaining: ${pickaxes}/${MAX_PICKAXES}`}>
            ...
            <div className="bg-black/70 rounded-lg px-3 py-2 flex items-center justify-start gap-3" title="Bombs Remaining">
            ...
            <div className="bg-black/70 rounded-lg px-3 py-2 flex items-center justify-start gap-3" title={`Reward per Coin (Mastery Lvl ${masteryCards} x Floor ${currentFloor})`}>
