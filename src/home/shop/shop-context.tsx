...
interface ShopContextType {
  ...
  formatShopCurrency: (amount: number) => string;
}
...
export const ShopProvider: FC<ShopProviderProps> = ({ children, onCurrencyUpdate, getShopItemsFunction }) => {
  ...
  const formatShopCurrency = (amount: number) => {
    // Using 'vi-VN' locale formats numbers like 1000 into "1.000"
