      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-md mx-auto flex flex-col items-center pt-8">
          ...
          <div className="w-full max-w-xs bg-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-lg p-3 mb-6 flex justify-around items-center animate-pulse">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-center gap-2">
                ...
                {/* QUAY LẠI PHƯƠNG PHÁP ĐÚNG: Dùng text + text-transparent */}
                <span className="text-lg font-bold bg-slate-700 text-transparent rounded-md w-14">X</span>
              </div>
            ))}
          </div>
          ...
          <div className="w-full px-2 mb-8 animate-pulse">
              <div className="flex justify-between items-baseline mb-2 px-1">
                  <span className="text-md font-bold tracking-wide bg-slate-700 text-transparent rounded-md w-24">X</span>
                  <span className="text-sm font-semibold bg-slate-700 text-transparent rounded-md w-16">X</span>
              </div>
                  ...
                  <div key={index} className="relative group rounded-xl bg-slate-800 p-px">
                      <div className="relative bg-slate-900/95 rounded-[11px] h-full flex flex-col items-center justify-between text-center w-28 sm:w-36 p-3 sm:p-4 gap-2 sm:gap-3 animate-pulse">
                          ...
                          <div className="flex-grow flex flex-col items-center gap-1">
                              {/* QUAY LẠI PHƯƠNG PHÁP ĐÚNG: Dùng text + text-transparent */}
                              <p className="text-base sm:text-lg uppercase font-bold tracking-wider bg-slate-700 text-transparent rounded-md w-16">X</p>
                              <p className="text-lg sm:text-xl font-black bg-slate-700 text-transparent rounded-md w-12">X</p>
                              <p className="text-xs text-slate-400 bg-slate-700 text-transparent rounded-md w-20">X</p>
                          </div>
                          <div className="w-full bg-slate-900 border border-slate-700 rounded-lg py-1.5 sm:py-2 px-2 flex items-center justify-center gap-1.5 sm:gap-2 shadow-lg">
                              ...
                              <span className="text-sm sm:text-base font-bold bg-slate-700 text-transparent rounded-sm w-12">X</span>
                          </div>
                      </div>
                  </div>
              ))}
