...
const StickmanShadowFinal = ({ onClose }) => {
  ...
  // [UPDATE] Auto start game when component mounts
  useEffect(() => {
    // Timeout nhỏ để đảm bảo container đã render
    setTimeout(() => {
        initGame();
    }, 100);
  }, []);
  ...
  return (
    <div className="w-full h-screen bg-black overflow-hidden relative touch-none select-none font-sans">
      ...
      {/* --- ADDED HEADER --- */}
      {/* [UPDATE] Gọi onClose khi nhấn Home */}
      ...
      {/* --- MENU MODAL ĐÃ BỊ LOẠI BỎ ĐỂ VÀO GAME LUÔN --- */}
