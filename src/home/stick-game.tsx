                                    ...
                                    {canRise && (
                                        <button
                                            className={`
                                                ...
                                                ${isRisePressed
                                                    ? 'scale-90 bg-slate-800 border-[2px] border-purple-400/50 shadow-[0_0_15px_rgba(168,85,247,0.4)]'
                                                    : 'scale-100 bg-slate-900/60 border-[2px] border-gray-500/30 shadow-[0_4px_10px_rgba(0,0,0,0.5)] animate-bounce'
                                                }
                                            `}
                                        ...
                                        >
                                            {/* Vòng trang trí bên trong (Mờ hơn Attack) */}
                                            <div className={`absolute inset-1 rounded-full border pointer-events-none transition-colors duration-100 ${isRisePressed ? 'border-purple-300/20' : 'border-gray-500/20'}`}></div>
