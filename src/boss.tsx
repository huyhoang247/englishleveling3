...
// --- Component Modal Phần Thưởng (Thiết kế mới) ---
    ...
    >
      ...
      >
        ...
        <div className="p-5 pt-8">
          ...
          {/* Giao diện phần thưởng nhỏ gọn */}
          <div className="flex justify-center items-center gap-8 bg-slate-800/50 p-4 rounded-lg border border-slate-700">
            {/* Phần thưởng Vàng */}
            ...
            {/* Đường phân cách */}
            <div className="h-10 w-px bg-slate-600/70"></div>
