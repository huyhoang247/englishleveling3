...
interface SidebarLayoutProps {
  ...
  activeScreen: string; // NEW: Prop to indicate the currently active screen
}
                    ...
                    <li key={item.id} className={`${index !== 0 ? 'border-t border-opacity-20 border-gray-700' : ''}`}>
                      <a
                        ...
                        className={`
                          ...
                          ${activeScreen === item.id // Use activeScreen prop to determine active state
                      ...
                      >
                        <div className={`
                          ...
                          ${activeScreen === item.id // Use activeScreen prop for icon active state
