...
// ... (Tất cả các helper components và data tĩnh giữ nguyên không đổi)
...
// ... (Các component card, modal, ... cũng giữ nguyên)
...
// --- >>> END: COMPONENT CATEGORY TABS ĐÃ ĐƯỢC THAY THẾ <<< ---
