// --- START OF FILE shop.tsx (REVISED) ---
...
const gemPackages = [
    { id: 'gem_1', gems: 100, price: 20000, label: 'Gói Tiểu' },
    { id: 'gem_2', gems: 260, price: 50000, label: 'Gói Nhỏ', bonus: '4% bonus' },
    { id: 'gem_3', gems: 525, price: 100000, label: 'Gói Trung', bonus: '5% bonus' },
    { id: 'gem_4', gems: 1100, price: 200000, label: 'Gói Đại', bonus: '10% bonus' },
    { id: 'gem_5', gems: 2875, price: 500000, label: 'Gói Khổng Lồ', bonus: '15% bonus' },
    { id: 'gem_6', gems: 6000, price: 1000000, label: 'Gói Thần Thánh', bonus: '20% bonus' },
];
        ...
        <div className="w-full h-screen bg-[#0a0a14] font-sans text-white flex flex-col">
            ...
            <div className="flex-1 relative overflow-y-auto bg-[#0a0a14] [background-image:radial-gradient(circle_at_center,_#16213e,_#0a0a14)]">
                <div className="relative max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-2 pb-24">
                    ...
                    {/* --- START: ĐÃ SỬA LỖI CUỘN TRANG TẠI ĐÂY --- */}
                    
                    {/* 1. Wrapper để ghim thanh tabs */}
                    <div className="sticky top-0 z-30 bg-[#0a0a14] pt-6 pb-4 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 [background-image:radial-gradient(circle_at_center,_#16213e,_#0a0a14)]">
                        <CategoryTabs activeCategory={activeCategory} setActiveCategory={setActiveCategory} />
                    </div>

                    {/* 2. Main content chỉ chứa các items có thể cuộn */}
                    <main>
                        {/* 3. Thêm margin-top để nội dung không bị thanh tabs che */}
