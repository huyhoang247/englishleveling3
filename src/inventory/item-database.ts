...
export const itemDatabase = new Map<number, ItemDefinition>([
    ...
    [59, { id: 59, name: 'Giant\'s Hammer', type: 'weapon', rarity: 'A', description: 'Cây búa khổng lồ, gây sát thương vật lý cực lớn, yêu cầu sức mạnh khủng khiếp để sử dụng.', stats: { damage: 30, durability: 80, strength: 10 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2002_14_23%20PM.png', maxLevel: 30 }],
