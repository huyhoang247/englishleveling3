...
export const itemDatabase = new Map<number, ItemDefinition>([
    ...
    [55, { id: 55, name: 'Nomad Sword', type: 'weapon', rarity: 'E', description: 'Thanh kiếm của dân du mục, thích hợp cho những chuyến đi dài.', stats: { damage: 8, durability: 30 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/file_000000004f0c62309cbdcc6fea779fc6.png', maxLevel: 10, skills: [] }],
    [56, { 
        id: 56, name: 'Frostbite Spear', type: 'weapon', rarity: 'D', description: 'Ngọn giáo phủ băng, gây sát thương kèm hiệu ứng làm chậm.', 
        stats: { damage: 18, durability: 60, coldDamage: 5, slowEffect: 0.15 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/file_0000000062ac62309ccc99e40040f892.png', maxLevel: 20,
        skills: [
    ...
    [59, { 
        ...
        stats: { damage: 30, durability: 80, strength: 10 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2002_14_23%20PM.png', maxLevel: 30,
        skills: [
    ...
    [60, { 
        ...
        stats: { magicDamage: 15, manaRegen: 5, intelligence: 5 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2002_48_52%20PM.png', maxLevel: 25,
        skills: [
    ...
    [61, { 
        ...
        stats: { magicDamage: 12, manaRegen: 3 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2002_37_31%20PM.png', maxLevel: 20,
        skills: [
    ...
    [63, { 
        ...
        stats: { magicDamage: 35, manaRegen: 10, intelligence: 20, magicCritChance: 0.10 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2005_33_51%20PM.png', maxLevel: 45,
        skills: [
    ...
    [66, { 
        ...
        stats: { damage: 38, durability: 120, strength: 15, critChance: 0.05 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2006_19_37%20PM.png', maxLevel: 40,
        skills: [
    ...
    [70, { 
        ...
        stats: { damage: 65, darkDamage: 30, lifeSteal: 0.10, critChance: 0.15 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2007_46_39%20PM.png', maxLevel: 60,
        skills: [
    ...
    [71, { id: 71, name: 'Demon Knight\'s Spear', type: 'weapon', rarity: 'E', description: 'Ngọn giáo của Kỵ sĩ Quỷ, cung cấp sát thương cơ bản và độ bền tốt.', stats: { damage: 15, durability: 50, strength: 3 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2008_06_40%20PM.png', maxLevel: 15, skills: [] }],
    [72, { id: 72, name: 'Demon King\'s Daggers', type: 'weapon', rarity: 'A', description: 'Cặp dao găm của Quỷ Vương, cho phép tấn công nhanh và chí mạng cao, tẩm độc gây sát thương theo thời gian.', stats: { damage: 25, attackSpeed: 30, durability: 80, agility: 10, critChance: 0.15, poisonDamage: 5 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2008_14_19%20PM.png', maxLevel: 35, skills: [] }], // Cần thêm 5 skill
    [73, { id: 73, name: 'Divine Quarterstaff', type: 'weapon', rarity: 'B', description: 'Cây gậy chiến thần thánh, mang sức mạnh của ánh sáng, tăng cường sát thương phép và hồi phục mana.', stats: { magicDamage: 20, manaRegen: 7, durability: 90, lightDamage: 8, intelligence: 10 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2008_23_51%20PM.png', maxLevel: 30, skills: [] }], // Cần thêm 5 skill
    [74, { id: 74, name: 'Meteor Staff', type: 'weapon', rarity: 'A', description: 'Cây trượng chứa sức mạnh của thiên thạch, có thể triệu hồi mưa sao băng.', stats: { magicDamage: 30, fireDamage: 15, intelligence: 15, durability: 110 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2013%2C%202025%2C%2010_44_50%20AM.png', maxLevel: 40, skills: [] }], // Cần thêm 5 skill
    [75, {
        ...
        stats: { damage: 12, attackSpeed: 10, critChance: 0.05, agility: 5 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2013%2C%202025%2C%2012_29_58%20PM.png', maxLevel: 20,
        skills: [
