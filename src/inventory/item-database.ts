...
export const itemDatabase = new Map<number, ItemDefinition>([
    ...
    // [2, { id: 2, name: 'Thuốc hồi máu', type: 'potion', rarity: 'E', description: 'Hồi phục 50 điểm máu khi sử dụng.', stats: { healing: 50 }, icon: '🧪' }], // Đã xóa theo yêu cầu
    ...
    [60, { id: 60, name: 'Hard Armor', type: 'armor', rarity: 'B', description: 'Áo giáp cứng cáp, cung cấp khả năng phòng thủ vượt trội.', stats: { defense: 25, durability: 120 }, icon: 'https://raw.githubusercontent.com/huyhoang247/englishleveling3/refs/heads/main/src/icon/inventory/ChatGPT%20Image%20Jun%2012%2C%202025%2C%2002_26_49%20PM.png', maxLevel: 25 }],
