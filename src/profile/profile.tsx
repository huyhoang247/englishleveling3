...
export default function GameProfile() {
  ...
  const playerInfo = {
    ...
    title: `Lv. ${currentLevel}`, // Placeholder for compatibility
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-grow">
                  <div className="flex items-center space-x-2 mb-1">
                   ...
                   {/* HEADER STATUS SECTION (VIP/NORMAL) - MOVED UP */}
                   ...
                   {/* LEVEL BADGE - MOVED DOWN */}
                   <div className="flex items-center">
                     <div className="bg-slate-800 border border-cyan-500/30 rounded-md px-2 py-0.5 shadow-sm inline-flex items-center">
                        <span className="text-xs text-cyan-500 font-lilita mr-1">Lv.</span>
                        <span className="text-sm font-lilita text-cyan-100 tracking-wider">
                            {currentLevel}
                        </span>
                     </div>
                  </div>
