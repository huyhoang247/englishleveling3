...
const triggerOptions = {
    ...
    timeoutSeconds: 60,
    // Thêm maxInstances vào đây để dùng cho v1
    maxInstances: 10,
};
...
export const onVocabOpened = functions
    ...
    .runWith({ memory: triggerOptions.memory, timeoutSeconds: triggerOptions.timeoutSeconds, maxInstances: triggerOptions.maxInstances })
